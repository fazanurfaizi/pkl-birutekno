                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="text-center">
                                ...
                                <div class="panel-body">                    
                                    <v-form ref="forgotPasswordForm" id="forgot-password-form" role="form" autocomplete="off" class="form">                
                                        <div class="form-group">
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-envelope color-blue"></i></span>
                                                <input :rules="emailRules" label="Email" name="email" type="email" 
                                                    v-model="email" placeholder="email address" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group">
